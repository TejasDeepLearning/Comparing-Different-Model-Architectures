...
model = tf.keras.models.load_model("/home/tejas/Documents/Deep Learning/My Work/CNN/cifar10/lenet5/lenet5.h5")
tf.keras.utils.plot_model(model, to_file='lenet5.png', show_shapes=True, show_layer_names=True, show_layer_activations=True, dpi=300)
